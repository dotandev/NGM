        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          ...
          >
            ...
            <div style={{ padding: "64px 48px", display: "flex", flexDirection: "column", justifyContent: "center" }}>
              ...
              <div style={{ display: "flex", gap: "16px" }}>
                ...
                >
                  <span style={{ fontSize: "16px", fontWeight: "bold", color: "inherit" }}>Be</span>
                </a>
          ...
          >
            ...
            >
              ...
              >
                <h3 style={{ fontSize: "24px", fontWeight: "bold", color: "white", margin: 0 }}>DAY 01</h3>
                <p style={{ color: "rgba(255, 255, 255, 0.8)", margin: "8px 0 0 0" }}>12 Jan - Thursday</p>
              </div>
              <div
                style={{
              ...
              >
                <h3 style={{ fontSize: "24px", fontWeight: "bold", color: "rgb(34, 197, 94)", margin: 0 }}>DAY 02</h3>
                <p style={{ color: "#666", margin: "8px 0 0 0" }}>14 Jan - Saturday</p>
              </div>
              <div
                style={{
                  backgroundColor: "rgb(15 25 144 / 1)",
