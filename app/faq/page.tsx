...
export default function FAQPage() {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer:
        "Unfortunately, no refund. Do Sadaqah.",
    },
    {
      question: "What are the payment option?",
      answer:
        "Cash, Transfer, E gbewa! But use our registration ink to pay",
    },
    {
      question: "Any possibilities of schedule chanfe?",
      answer:
  ...
  return (
    <main style={{ backgroundColor: "#EAFFF3", minHeight: "100vh", padding: "120px 24px 80px" }}>
              ...
              >
                ...
                <div
                  style={{
                    ...
                    height: "32px",
                    borderRadius: "50%",
                    backgroundColor: openItems.includes(index) ? "rgb(15 25 144 / 1)" : "#f5f5f5",
                    display: "flex",
                    alignItems: "center",
